...
Project1 = Class.extend({
	...
	show_user_property_backtable: function(page,numPages,values,records_per_page,length,flag) {
		var me = this
		$("<div class='col-md-12 row' ><p  style='float:right;text-align=right'><button class='btn btn-sm btn-default btn-address'> <i class='icon-plus'></i><a id='new'> New Project Commercial</a></button></p></div>\
			<div id='property' class='col-md-12 row'>\
				...
				$($(me.body).find("#"+i+"")).find("#p_id").append('<div class="row property-row"><a class="pv" style="margin-left:12px;" id="'+d[0]['name']+'">'+d[0]['name']+'<a></div>')
				$($(me.body).find("#"+i+"")).find("#property-ownership").append('<div class="row property-row">'+d[0]['p_id'] ? d[0]['p_id'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#floors").append('<div class="row property-row">'+d[0]['p_stage'] ? d[0]['p_stage'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#maintainance").append('<div class="row property-row">'+d[0]['s_type'] ? d[0]['s_type'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#deposite").append('<div class="row property-row">'+d[0]['prop_date'] ? d[0]['prop_date'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#age").append('<div class="row property-row">'+d[0]['start_date'] ? d[0]['start_date'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#furnishing_type").append('<div class="row property-row">'+d[0]['end_date'] ? d[0]['end_date'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#society_name").append('<div class="row property-row">'+d[0]['pro_per'] ? d[0]['pro_per'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#area").append('<div class="row property-row">'+d[0]['customer'] ? d[0]['customer'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#p_type").append('<div class="row property-row">'+d[0]['p_type'] ? d[0]['p_type'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#address").append('<div class="row property-row">'+d[0]['p_value'] ? d[0]['p_value'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#location").append('<div class="row property-row">'+d[0]['customer_name'] ? d[0]['customer_name'] : ""+'</div>')
				$($(me.body).find("#"+i+"")).find("#property-name").append('<div class="row property-row">'+d[0]['register_addr'] ? d[0]['register_addr'] : ""+'</div>')


				if(d[0]['child_records']!=null){
					$.each(d[0]['child_records'], function(j, k){
